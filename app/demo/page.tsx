...
import ExperienceDemoSection from "@/components/ExperienceDemoSection";
         ...
         <div className="max-w-6xl mx-auto px-4 pt-16" >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 justify-center items-stretch gap-20 md:gap-x-24 md:gap-y-8">
                  ...
                  <div className="bg-white rounded-2xl shadow-xl p-8 w-full md:w-[580px] h-[640px] flex flex-col items-start transition-all hover:shadow-2xl hover:scale-105">
                    ...
                    <button className="bg-yellow-400 hover:bg-yellow-500 text-white font-bold px-8 py-4 rounded-lg transition-all mt-auto text-lg shadow-lg hover:shadow-xl flex items-center gap-3">
                      View Admin Demo 
